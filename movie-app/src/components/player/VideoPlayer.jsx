...
const VideoPlayer = forwardRef(({ src, onStateChange, onReady, syncAutoPlay = true, initialTime = 0 }, ref) => {
  ...
  return (
    <div className="w-full aspect-video bg-black rounded-xl overflow-hidden shadow relative z-20 group">
      ...
      <button 
        ...
        className="absolute top-4 right-4 z-50 p-2 bg-black/50 hover:bg-black/80 text-white rounded-full transition-all opacity-0 group-hover:opacity-100"
      ...
      {showSettings && (
        <div className="absolute inset-0 z-50 bg-black/80 flex items-center justify-center p-4">
            <div className="bg-gray-800 rounded-xl p-6 w-full max-w-sm border border-gray-700 shadow-2xl relative animate-fadeIn">
                <button 
